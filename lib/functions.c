...
void vitmlsesova(const float *in, float *llr, int N, float* xk, vitstate **all);

void convenc(char *in, char *out, int SIZE);
void interleaver(float const* in, float *out, int R,int C);
